...
import com.prodapt.bicyclespring.business.LoggedInUser;
...
public class LoginController {
    ...
    @PostMapping
    public String login(@ModelAttribute("user") User user, BindingResult bindingResult, RedirectAttributes attr) throws CycleShopBusinessException {
